...
```bash
claude mcp add memfault \
--transport http https://demo-api.memfault.com/api/v0/organizations/acme-inc/projects/shapemate/mcp \
--header "Authorization: Basic <YOUR_MEMFAULT_API_KEY>"
```
